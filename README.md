...
| [`nanocodex-network`](crates/experimental/nanocodex-network/README.md) | Durable Iroh identities, bootstrap admission, named application protocols, authenticated peer streams, and local service bridges |
