...
use tact_crossterm::event::{Event, KeyCode, KeyEvent, KeyEventKind, KeyModifiers};
use tact_ratatui::{
    Frame,
    buffer::Buffer,
...
mod tests {
    ...
    fn fast_mode_places_a_yellow_bolt_after_effort() {
        ...
        assert!(
            top[bolt]
                .modifier
                .contains(tact_ratatui::style::Modifier::BOLD)
        );
    }
    ...
    fn pro_mode_places_a_green_badge_after_the_fast_mode_bolt() {
        ...
        for cell in &top[pro..pro + 3] {
            ...
            assert!(cell.modifier.contains(tact_ratatui::style::Modifier::BOLD));
        }
    }
