...
use tact_crossterm::event::{Event, KeyCode, KeyEventKind};
use tact_ratatui::{
    Frame,
    layout::Rect,
    style::Style,
...
impl Component for ReviewDownloadConfirmation {
    ...
    fn render(&mut self, frame: &mut Frame<'_>, area: Rect, theme: &Theme) {
        ...
        let lines = vec![
            ...
            Line::from(""),
            Line::styled(
                "Download the matching, checksummed bundle from this Nanocodex release?",
...
mod tests {
    ...
    fn download_message_fits_inside_the_popup() {
        ...
        assert!(
            text.contains("Download the matching, checksummed bundle from this Nanocodex release?")
        );
        for y in 1..8 {
