...
mod tests {
    ...
    use tact_ratatui::{Terminal, backend::TestBackend, layout::Rect};
    ...
    fn plasma_uses_the_effort_color_with_multiple_character_densities() {
        ...
        assert_eq!(
            colors,
            [
                tact_ratatui::style::Color::Red,
                tact_ratatui::style::Color::Rgb(0xD7, 0xD7, 0xD7),
            ]
            .into_iter()
            .collect::<std::collections::HashSet<_>>()
        );
