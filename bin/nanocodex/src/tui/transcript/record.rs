...
pub(super) const LOCAL_SOURCE: &str = "nanocodex";
const LEGACY_TACT_SOURCE: &str = "tact";

pub(super) fn is_local_source(source: &str) -> bool {
    matches!(source, LOCAL_SOURCE | LEGACY_TACT_SOURCE)
}
...
mod tests {
    ...
    fn local_record_uses_typed_payload() {
        ...
        assert_eq!(encoded["source"], "nanocodex");
