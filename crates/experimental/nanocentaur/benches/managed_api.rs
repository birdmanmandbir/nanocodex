...
use nanocentaur::{
    ...
    FreePaymentGate, ManagedAgentFactory, MockAgentFactory, PolicyStore, SecretGateway,
    TurnActionResponse,
};
...
impl ManagedHarness {
    async fn new() -> Self {
        ...
        let app = ApiState::new(
            ...
            Arc::new(SecretGateway::new("http://127.0.0.1:3000").expect("secret gateway base URL")),
        )
        .router();
