...
impl Session {
    ...
    fn ensure_capture_inactive(&self) -> Result<(), BrowserError> {
...
fn permission_names(permission: BrowserPermission) -> &'static [&'static str] {
    match permission {
...
fn action_result(sequence: u64, action: BrowserActionName) -> BrowserActionResult {
...
fn requires_action_completion(action: BrowserActionName) -> bool {
    matches!(
        action,
...
fn captures_action_outcome(action: BrowserActionName) -> bool {
