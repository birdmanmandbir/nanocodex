...
///
/// This is the boundary for PaperBench, MLE-style competitions, and
/// private suites whose official grader is executable code. Nanocodex owns the
/// VM lifecycle; the benchmark continues to own its image and `test.sh`.
#[derive(Clone, Debug)]
