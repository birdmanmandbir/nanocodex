...
`crates/experimental/nanocodex-browser/assets-src` and
[`AXE_NOTICE.md`](../crates/experimental/nanocodex-browser/assets/AXE_NOTICE.md).
...
notices are recorded under `crates/experimental/nanocodex-browser/assets-src`
and in
[`REACT_DIAGNOSTICS_NOTICE.md`](../crates/experimental/nanocodex-browser/assets/REACT_DIAGNOSTICS_NOTICE.md).
