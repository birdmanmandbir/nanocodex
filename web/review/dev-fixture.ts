...
const overview = `
  ...
  <p>This change introduces a browser-based review surface launched from Nanocodex. The diff is snapshotted before the overview is generated, so comments always refer to the exact code shown.</p>
