/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 437e4c8288f538ff4afebaf3a9f89b14)
...
interface __BaseEnv_Env {
	...
	BACKUP_BUCKET_NAME: "nanocodex-ci-development" | "nanocodex-ci-preview" | "nanocodex-ci";
	CI_PUBLIC_ORIGIN: "http://host.docker.internal:8787" | "https://nanocodex-preview.gakonst.workers.dev" | "https://nanocodex.me-7fb.workers.dev";
	CLOUDFLARE_ACCOUNT_ID: "7fb82fc3b80331b2cd45f097acbd9ffc" | "16ce0442a940f01beefdb15a196a43ea";
	...
	NANOCODEX_SANDBOX_CONTROL_TOKEN: string;
	...
	CI_REPOSITORY: DurableObjectNamespace<import("./worker/entry").CiRepository>;
	CI_MACOS_JOBS: DurableObjectNamespace<import("./worker/entry").CiMacJobs>;
	CI_RELEASES: DurableObjectNamespace<import("./worker/entry").CiReleases>;
	SANDBOX: DurableObjectNamespace<import("./worker/entry").CiSandbox>;
	MULTIPLAYER_BACKEND?: Fetcher /* nanocodex-durable-agent */;
	CI_WORKFLOW: Workflow<Parameters<import("./worker/entry").NanocodexCI['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/entry");
		durableNamespaces: "ByokSession" | "ChatGptSession" | "GitRepository" | "EvalCoordinator" | "ChatGptEgress" | "ThreadGitRepository" | "CiRepository" | "CiSandbox" | "CiMacJobs" | "CiReleases";
	}
	interface DevelopmentEnv {
		...
		BACKUP_BUCKET_NAME: "nanocodex-ci-development";
		CI_PUBLIC_ORIGIN: "http://host.docker.internal:8787";
		CLOUDFLARE_ACCOUNT_ID: "7fb82fc3b80331b2cd45f097acbd9ffc";
		GIT_MIRROR_TOKEN: string;
		CI_MASTER_SOURCE_WRITE_TOKEN: string;
		CI_PR_SOURCE_WRITE_TOKEN: string;
		CI_CONTROL_TOKEN: string;
	...
	interface PreviewEnv {
		...
		ASSETS: Fetcher;
		ENVIRONMENT: "preview";
		BACKUP_BUCKET_NAME: "nanocodex-ci-preview";
		CI_PUBLIC_ORIGIN: "https://nanocodex-preview.gakonst.workers.dev";
		CLOUDFLARE_ACCOUNT_ID: "16ce0442a940f01beefdb15a196a43ea";
		GIT_MIRROR_TOKEN: string;
		CI_MASTER_SOURCE_WRITE_TOKEN: string;
		CI_PR_SOURCE_WRITE_TOKEN: string;
		CI_CONTROL_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BACKUP_BUCKET_NAME" | "CI_PUBLIC_ORIGIN" | "CLOUDFLARE_ACCOUNT_ID" | "GIT_MIRROR_TOKEN" | "CI_MASTER_SOURCE_WRITE_TOKEN" | "CI_PR_SOURCE_WRITE_TOKEN" | "CI_CONTROL_TOKEN" | "CI_MACOS_RUNNER_TOKEN" | "CI_RELEASE_TOKEN" | "NANOCODEX_SANDBOX_CONTROL_TOKEN" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY">> {}
}
